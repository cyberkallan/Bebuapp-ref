            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.call_rounded, size: 18, color: BebuTheme.text),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                ...
                const Icon(Icons.chevron_right_rounded, color: BebuTheme.textFaint),
              ],
            ),
          ),
        );
                    ...
                    GetBuilder<PersonalChatScreenController>(
                      ...
                      builder: (c) => PressScale(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.arrow_forward_rounded, size: 22, color: BebuTheme.text),
                        ),
                      ),
                    ),
                  ],
