                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(logic.callType == 'audio' ? EnumLocale.txtIncomingAudioCalling.name.tr : EnumLocale.txtIncomingVoiceCalling.name.tr,
                  ...
                  builder: (logic) {
                    return GestureDetector(
                      onTap: () async {
                        ...
                        log("logic.callType >>>>>>>>>>>>>>>>>>>>   ${logic.callType}");
                        ...
                        if (logic.isCallResponse == false) {
                          ...
                          if (logic.callType == "audio") {
                            SocketEmit.emitCallResponseProcessed(
                              ...
                              callType: "audio",
                              callMode: logic.callMode ?? '',
                              callerRole: logic.callerRole == 'user' ? 'user' : 'listener',
                              receiverRole: logic.receiverRole == 'listener' ? 'listener' : 'user',
                              receiverName: logic.receiverName ?? '',
                              receiverImage: logic.receiverImage ?? '',
                              callerName: logic.callerName ?? '',
                              callerImage: logic.callerImage ?? '',
                        ...
                        // Optionally, navigate or update UI here immediately
                        Utils.showLog("Call accepted, emit event sent");
                      },
