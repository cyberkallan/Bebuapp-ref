...
final Map<String, String> enUS = {
  ...
  EnumLocale.txtListenerWithdrawDescription.name:
      "1. You can withdraw your earned coins as real money once you meet the minimum withdrawal threshold set by the platform. Make sure your profile and payment details are fully verified to avoid delays in processing your withdrawal request.",
  EnumLocale.txtListenerGuide.name:
      "1. Your wallet balance shows the total coins you’ve earned from users who call you as a listener. These coins are rewarded to you for your time and engagement during the call.\n\n2. Users purchase coins and spend them by calling listeners like you. The more users call you, the more coins you earn in your wallet.\n\n3. Coins earned can be accumulated and later withdrawn as money, depending on the platform’s withdrawal rules. Keep engaging actively to grow your wallet balance.",
  ...
  EnumLocale.txtHostHomeDescription.name:
      "Get rewarded while helping others! As a listener, you can earn  coins per minute during random calls. Support someone in need and earn at the same time.",
  ...
  EnumLocale.txtSelectLanguages.name:
      "Choose the languages you are comfortable speaking with listeners. This helps us connect you with the right people who need support in those languages.",
  ...
  EnumLocale.txtBecomeHostDescription.name:
      "Listeners play a vital role by offering support, guidance, or simply a listening ear to users who need someone to talk to. If you’re empathetic, patient, and ready to help others, becoming a listener is the perfect way to make a positive impact.",
