...
files plus a manifest.json into:
  ...
  talkin/backend/assets/avatar-studio/   (served at /avatar-studio, seeds the catalog)
  talkin/app/assets/avatar_studio/       (bundled in the app for instant rendering)

Run from anywhere:  python3 talkin/tools/build_avatar_assets.py
Requires: git, Pillow.
"""
import json
import os
