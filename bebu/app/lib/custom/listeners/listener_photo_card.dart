                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: BebuTheme.title(size: 17, color: BebuTheme.onPhoto),
                        ),
                        if (subtitle != null && subtitle!.isNotEmpty) ...[
                          const SizedBox(height: 3),
                          Text(subtitle!, maxLines: 1, overflow: TextOverflow.ellipsis, style: BebuTheme.body(size: 11.5, color: BebuTheme.onPhotoMuted)),
                        ],
                      ],
                    ),
                  ),
...
class ActionOrb extends StatelessWidget {
  const ActionOrb({
    ...
    this.gradient,
    this.color,
    this.iconColor = BebuTheme.onPhoto,
    this.iconSize = 26,
    this.glow,
    this.semanticLabel,
  });
